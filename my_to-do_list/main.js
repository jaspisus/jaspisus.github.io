const form = document.querySelector('.wrapper__input-box')
const ulList = document.querySelector('.wrapper__list')
const tasksArr = []
...
const addTask = e => {
  ...
  li.className = 'wrapper__list__list-item';
  li.innerHTML = `
  <div class="wrapper__list__list-item__box">
    <p>${task.value}</p>
    <button class="wrapper__list__list-item__box__delete-btn">
